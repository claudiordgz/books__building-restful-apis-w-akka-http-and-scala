...
import bookstore.models._
import bookstore.services.DatabaseService

import scala.concurrent.{ExecutionContext, Future}


class CategoryRepository (val databaseService: DatabaseService)(implicit executionContext: ExecutionContext) extends CategoryTable {
